...
<html>
    ...
    <head>
        ...
        <title>REKAP STOK OBAT BULAN <?php echo $bln." TAHUN ".$thn?></title>
    ...
    <body style="font-size:12px; font-family: Tahoma, Geneva, sans-serif">
        ...
        <h5 class="text-center">
            <img src="<?php echo base_url('img/favicon.png')?>" style="margin-botom: 10px" height=70><br>REKAP STOK OBAT BULAN <?php echo $bln." TAHUN ".$thn?>
            <br>
            <small>KATA KUNCI : <?php echo $q?></small>
        </h5>
        
        <br>
        <?php $this->load->view('laporan/laporanstokbarang/tabel', array('tp' => 1))?>
        </table>
    </body>
</html>