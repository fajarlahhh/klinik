...
//Custom
defined('TEMPLATE_COMPONEN_PATH')        OR define('TEMPLATE_COMPONEN_PATH', 'template'.DIRECTORY_SEPARATOR.'bower_components'.DIRECTORY_SEPARATOR); // path componen template
