...
<html>
    ...
    <head>
        ...
        <title>LAPORAN BARANG MASUK TANGGAL <?php echo date('d M Y', strtotime($tgl1))." s/d ".date('d M Y', strtotime($tgl2))?></title>
    ...
    <body style="font-size:12px; font-family: Tahoma, Geneva, sans-serif">
        ...
        <h5 class="text-center">
            <img src="<?php echo base_url('img/favicon.png')?>" style="margin-botom: 10px" height=70><br>LAPORAN BARANG MASUK TANGGAL <?php echo date('d M Y', strtotime($tgl1))." s/d ".date('d M Y', strtotime($tgl2))?>
            <br>
            <small>KATA KUNCI : <?php echo $q?></small>
        </h5>
        
        <br>
        <?php $this->load->view('laporan/laporanbarangmasuk/tabel', array('tp' => 2))?> 
    </body>
</html>